...
<div class="botoes-acoes">
  ...
  <a href="pesquisa.php" class="btn-painel">Visualizar Produtos</a>
  <a href="Uploadphp.php" class="btn-painel">Carregar Imagem</a>
...
<div class="popup-overlay" id="popupProd">
  <div class="popup-content">
    ...
    <form name="cadastro" action="mostrar_cadastro.php" method="POST">
      ...
      <p><b>Preço:</b><br><input type="text" name="fpreco" required></p>
      <p><b>Tipo:</b><br><input type="text" name="ftipo" required></p>
      <p><b>Descrição:</b><br><input type="text" name="fdescricao" required></p>
      <p><b>Quantidade:</b><br><input type="number" name="fquant" required></p>
