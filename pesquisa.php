  ...
  <?php
    ...
    while ($dados = mysqli_fetch_array($query)) {
      ...
      echo "<tr>
              ...
              <td><a href='apagar.php?id={$dados['id']}'><img src='deleta.png' width='30' height='30'></a></td>
              <td><a href='alteratipo.php?id=$id'><img src='alterar.jpg' width='30' height='30'></a></td>
              <td><a href='alterastatus.php?id=$id'><img src='status.svg' width='30' height='30'></a></td>
